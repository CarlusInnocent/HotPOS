        ...
        <div className="flex flex-1 flex-col">
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold">Manage Refunds</h1>
                <p className="text-muted-foreground">Process and approve customer refunds</p>
              </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardDescription>All Refunds</CardDescription>
            ...
            {selectedRefund?.status === 'PENDING' && (
              <>
                <Button 
                  ...
                  onClick={() => { handleRejectRefund(selectedRefund); setIsViewDialogOpen(false) }}
                >
                ...
                <Button 
                  ...
                  onClick={() => { handleApproveRefund(selectedRefund); setIsViewDialogOpen(false) }}
                >
