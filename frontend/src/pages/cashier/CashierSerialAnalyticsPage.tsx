...
export function CashierSerialAnalyticsPage() {
  ...
  const paginatedSerials = filteredSerials.slice((currentPage - 1) * pageSize, currentPage * pageSize)
                    ...
                    {filteredSerials.length > 0 && (
                      <div className="flex items-center justify-between px-2 py-4 border-t">
                        ...
                        <div className="text-sm text-muted-foreground">
                          Showing {(currentPage - 1) * pageSize + 1}-{Math.min(currentPage * pageSize, filteredSerials.length)} of {filteredSerials.length}
                        </div>
                        <div className="flex items-center gap-2">
