...
export function CashierHistoryPage() {
  ...
  // Helper to get today's date string in local time (avoids UTC offset issues)
  ...
  // Date range filter - initialize with current dates (call functions with ())
  ...
  const loadSales = async () => {
    ...
    try {
      ...
      // Show all branch sales (not just current user's)
      setSales(data)
    } catch (error) {
          ...
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">View your past sales transactions</p>
              </div>
