...
export function CashierPurchasesPage() {
  const { user } = useAuth()
  ...
  // Receive confirmation with selling price updates
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Filter to show only pending purchases that need to be received
  ...
  const openReceiveDialog = (purchase: Purchase) => {
    ...
    // Initialize selling price updates with current selling prices
  ...
  const handleReceive = async () => {
    ...
    setIsReceiving(true)
    try {
      // Build items array with selling price updates and serial numbers
          ...
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">Create purchase orders and receive incoming stock</p>
              </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {showAll ? "All purchase orders for your branch" : "Purchases waiting to be received at your branch"}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
                ...
                ) : (showAll ? allPurchases : purchases).length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    {showAll ? "No purchases found." : "No pending deliveries at the moment."}
                  </div>
                ) : (
      ...
      <Dialog open={isReceiveDialogOpen} onOpenChange={setIsReceiveDialogOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Confirm receipt and optionally update selling prices for this branch
            </DialogDescription>
          </DialogHeader>
